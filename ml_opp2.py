...
######################################COMBINE GAME OPP RUNS #########################################
    ...
    def update_columns(self):
       ...
       'away_is_winner', 'game_type', 'away_Date','home_Current_win_pct','home_prev_win_pct','Rolling_10D_win_x','Rolling_30D_win_x', 'away_Current_win_pct', 'away_prev_win_pct', 
         ...
         'home_opp_prev', 'Rolling_10D_opp_home', 'Rolling_30D_opp_home', 'away_opp_Current', 'away_opp_prev', 'Rolling_10D_opp_away', 'Rolling_30D_opp_away', 'lowvig_home', 'lowvig_away', 'home_mean', 'away_mean', 'pinnacle_home', 'pinnacle_away', 'bovada_home','bovada_away']]
...
class Train_Model(Combine_Data):
    ...
    def predict_(self):
        self.run_training()
        self.test_model =  'bayesian_tests/experiment_21/test_data'
