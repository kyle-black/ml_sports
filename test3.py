...
JOIN weighted_team_batting AS home_team_batting ON {home_team}
JOIN weighted_team_batting AS away_team_batting ON {away_team}
JOIN weighted_team_fielding AS home_team_fielding ON {home_team}
JOIN weighted_team_fielding AS away_team_fielding ON {away_team}
JOIN weighted_team_pitching AS home_team_pitching ON {home_team}
JOIN weighted_team_pitching AS away_team_pitching ON {away_team}
...
def prepare_data(games):
    conn = sqlite3.connect('your_database_name.db')  # Replace with the name of your database
    df_list = []
...
FROM games
JOIN weighted_team_batting AS home_team_batting ON home_team_batting.Tm = '{home_team}'
JOIN weighted_team_batting AS away_team_batting ON away_team_batting.Tm = '{away_team}'
JOIN weighted_team_fielding AS home_team_fielding ON home_team_fielding.Tm = '{home_team}'
JOIN weighted_team_fielding AS away_team_fielding ON away_team_fielding.Tm = '{away_team}'
JOIN weighted_team_pitching AS home_team_pitching ON home_team_pitching.Tm = '{home_team}'
JOIN weighted_team_pitching AS away_team_pitching ON away_team_pitching.Tm = '{away_team}'
'''

        game_df = pd.read_sql_query(sql_query, conn)
        df_list.append(game_df)
