...
JOIN team_batting AS away_team_batting ON games.away_team = away_team_batting.Tm AND games.season = away_team_batting.season
JOIN team_fielding AS home_team_fielding ON games.home_team = home_team_fielding.Tm AND games.season = home_team_fielding.season
JOIN team_fielding AS away_team_fielding ON games.away_team = away_team_fielding.Tm AND games.season = away_team_fielding.season
JOIN team_pitching AS home_team_pitching ON games.home_team = home_team_pitching.Tm AND games.season = home_team_pitching.season
JOIN team_pitching AS away_team_pitching ON games.away_team = away_team_pitching.Tm AND games.season = away_team_pitching.season
WHERE (games.home_is_winner=0 OR games.home_is_winner=1);
...
df.to_csv('19_21_22_results.csv', index=False)